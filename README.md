...
**0 open roles · 0 new this week · 4,108 companies tracked · updated Aug 10, 2026 at 23:42 UTC**
...
- **An engine, not a spreadsheet** - 4,108 companies polled every 2 hours across 11 job platforms, ~100 tests, full source in this repo.
...
| Atomic Semi | Aug 15 | ~Aug 15 · in ~5d | ⏳ waiting |
| Datadog | Aug 18 | ~Aug 18 · in ~8d | ⏳ waiting |
| Shopify | Aug 19 | ~Aug 19 · in ~9d | ⏳ waiting |
| Capital One | Aug 20 | ~Aug 20 · in ~10d | ⏳ waiting |
| NVIDIA | Aug 24 | ~Aug 24 · in ~14d | ⏳ waiting |
| Pinterest | Sep 24 | ~Sep 24 · in ~45d | ⏳ waiting |
...
_Engine (last run): 4,108 companies across 11 ATS platforms · 99% fetch success · completed in 314.4s._
