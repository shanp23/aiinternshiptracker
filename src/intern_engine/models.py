...
class Job:
    ...
    category: str = "Other"
    sponsorship: str = "unknown"   # legacy field, kept for store compatibility
    coding: str = "unknown"        # coding-required | will-train | tools-preferred | unknown
    loc_tier: str = ""             # "triangle" | "remote" (set by the pipeline)
